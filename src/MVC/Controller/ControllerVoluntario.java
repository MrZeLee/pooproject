...
//     private final String[] loginSucess = {"Menu Voluntário", "Definir Disponibildiade Para Entrega", "Decidir Entrega de Encomenda ~ Loja", "Tempo de transporte"};
...
//                 list.add("Definir Disponibildiade Para Entrega");
//                 for (String string : this.getModel().getEncomendas(voluntario)) {
//                     list.add(string);
//                 }
...
//                 list1.add("Decidir Entrega de Encomenda ~ Loja");
//                 for (String string : this.getModel().getEncomendas(voluntario)) {
//                     list1.add(string);
//                 }
